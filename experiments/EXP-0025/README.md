...
The first boundary is deliberately short. Each frozen final checkpoint is tested
under deterministic and two predeclared stochastic modes and must reproduce
across at least three game seeds and all three optimizer trials. Training-curve
success cannot pass the gate. Passing authorizes longer tails, then unassisted
full-boss evaluation. It does not establish normal-start Zone 2.
