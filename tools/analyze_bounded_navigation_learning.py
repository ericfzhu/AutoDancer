"""Validate and summarize EXP-0038 without selecting or promoting a checkpoint."""
...
def main():
    ...
    spec = ExperimentStore(Path("experiments")).load("EXP-0038")
    ...
    previous_config_path = Path("runs/bounded-learning-exp0036-complete/training/config.json")
    ...
    analysis = {"valid": True, "experiment_id": "EXP-0038", "pools": {}, "timing": {}, "paired": []}
    reports = {}
