"""Execute the immutable EXP-0038 pilot with hard budgets and no policy selection."""
...
OUT = ROOT / "runs/bounded-navigation-learning-exp0038"
...
def main():
    ...
    files += [reference / "manifest.json", reference / "validated-analysis.json", spec.path]
    ...
    reports = {}
    try:
        store.set_status("EXP-0038", "running")
        for stage in ("frozen", "pilot"):
