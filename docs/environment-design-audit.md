...
### 3. A2 has local recurrence but no durable spatial working memory
...
3. Train boss-to-Zone-2 first, then expand starts backward to Floor 3, Floor 2,
   and finally normal Floor 1. Curriculum success terminates the subtask, while
   final evaluation always begins from a normal All Zones reset.
